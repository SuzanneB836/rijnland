...
- You mentioned that the `sec_` folders will be deleted later — the rest of the design keeps the page-discovery logic simple and non-opinionated.
- If you want stronger input validation, we can whitelist sections and pages detected during startup and reject unexpected input.

If you'd like, I can:
- Run a quick scan to ensure `__DIR__` no longer appears anywhere.
- Commit these changes or run a formatting pass across the PHP files.

---
Edited and cleaned by your coding assistant.
